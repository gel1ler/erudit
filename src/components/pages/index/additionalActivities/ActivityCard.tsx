...
const ActivityCard = ({ title, description }: { title: string, description: string }) => {
  return (
    <Box 
    className="relative bg-gradient-to-r from-blue-500 to-purple-500 shadow-lg rounded-lg cursor-pointer
     p-6 flex flex-col items-center justify-center text-center hover:scale-[101%] transition-transform duration-300">

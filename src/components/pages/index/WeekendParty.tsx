    ...
    return (
        <div className="max-w-6xl grid gap-10 grid-cols-1 lg:grid-cols-2 mx-auto">
            <div className="flex flex-col gap-2">
                <Title left>Weekend Party</Title>
                <p data-aos='fade-up' className='text-4xl'>
                    Каждую субботу с 10:00 до 14:00
                </p>
                ...
                <div>
                    ...
                    <Typography color='#0e7490' data-aos='fade-up' mt={1} fontWeight={800} variant='h5'>2 000 ₽</Typography>
                    <Typography data-aos='fade-up'>Разовое посещение</Typography>
                    <Typography color='#0e7490' data-aos='fade-up' mt={2} fontWeight={800} variant='h5'>7 000 ₽</Typography>

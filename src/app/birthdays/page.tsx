...
export const metadata: Metadata = {
    title: 'Маленький Эрудит - Проведение дней рождений',
    description: 'Организуйте незабываемый день рождения для вашего ребенка в детском центре "Маленький Эрудит". Мы предлагаем весёлые программы, профессиональных аниматоров и вкусные сладости.',
    keywords: 'день рождения, детский праздник, аниматоры, мастер-классы, фотозона, сладости, торт, Маленький Эрудит',
    openGraph: {
        title: 'Маленький Эрудит - Проведение дней рождений',
        description: 'Организуйте незабываемый день рождения для вашего ребенка в детском центре "Маленький Эрудит". Мы предлагаем весёлые программы, профессиональных аниматоров и вкусные сладости.',
        url: 'https://www.small-erudite.ru/birthdays',

...
export const metadata: Metadata = {
    ...
    description: 'Присоединяйтесь к летнему клубу "Эрудит" для детей от 7 до 13 лет! Программа включает английский язык, фитнес, творчество, актёрское мастерство и многое другое. Смены с 29 июля по 30 августа.',
    keywords: 'летний клуб, детский лагерь, английский язык, фитнес, творчество, актёрское мастерство, прогулки, обед, Эрудит Центр',
    openGraph: {
        title: 'Эрудит Центр - Летний клуб Эрудит',
        description: 'Присоединяйтесь к летнему клубу "Эрудит" для детей от 7 до 13 лет! Программа включает английский язык, фитнес, творчество, актёрское мастерство и многое другое. Смены с 29 июля по 30 августа.',
